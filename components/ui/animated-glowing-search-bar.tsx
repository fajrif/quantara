  ...
  return (
    <div className="relative flex items-center justify-center isolate">
      <div id="poda" className="relative flex items-center justify-center group">
        ...
        {/* Glow Layer 2 */}
        <div className="absolute z-0 overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[3px] 
        ...
        {/* Glow Layer 6 */}
        <div className="absolute z-0 overflow-hidden h-full w-full max-h-[59px] max-w-[303px] rounded-xl blur-[0.5px] 
        ...
        <div id="main" className="relative z-10 group">
